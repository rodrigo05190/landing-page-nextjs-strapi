...
const Phone: React.FC<IdProduct> = ({ id_produto }, gtag) => {
  ...
  const onSubmit = async (values: any) => {
    ...
    try {
      const response = await axios.post(
        `https://trisul.controleid360.com.br/api/lead/mensagem`,
        {
          ...values,
          ...config,
          ...session,
      ...
      if (product?.gtag) {
        if(window.location.pathname == '/studios/isla-vila-madalena') {
          ...
          (window as any).gtag('event', 'conversion', {
            send_to: 'AW-11093319275/UyCJPz2v4YEOu82qkp',
          ...
          (window as any).gtag('event', 'conversion', {
            send_to: 'AW-11093319275/uIoCCLWpz_8YEOu82qkp',
            send_id: 'AW-11093319275',
          });
